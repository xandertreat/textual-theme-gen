...
import { ImportStep } from "~/features/themes/components/steps";
import { ThemeProvider } from "~/features/themes/context/theme";

const Index = () => {
	return (
		<ThemeProvider>
			<div class="flex max-h-fit min-h-screen w-full flex-col items-center gap-2 bg-base-100 py-4 text-center">
