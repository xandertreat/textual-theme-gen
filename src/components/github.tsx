...
const GitHub: Component<JSX.HTMLAttributes<HTMLAnchorElement>> = (props) => (
	<A
		class="btn btn-ghost btn-circle motion-duration-500 motion-ease-in-out motion-translate-x-in-[200%] motion-delay-500 fixed top-1 right-1 fhd:size-11 size-6 p-0.5 md:size-9"
		href={REPOSITORY_URL}
		target="_blank"
		{...props}
	>
