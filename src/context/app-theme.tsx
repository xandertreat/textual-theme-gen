...
> = (props) => {
	...
	return (
		<button
			{...props}
			type="button"
			class="btn btn-ghost btn-circle motion-duration-500 motion-ease-in-out -motion-translate-x-in-[200%] fixed inset-1 size-9 translate-x-full p-0.5 xl:size-11"
